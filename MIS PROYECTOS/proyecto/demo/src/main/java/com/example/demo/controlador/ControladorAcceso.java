...
import com.example.demo.modelo.PeticionAcceso;
import com.example.demo.modelo.RespuestaAcceso;
...
public class ControladorAcceso {
    ...
    @Autowired
    public ControladorAcceso(RepositorioSesion repositorioSesion, RepositorioUsuario repositorioUsuario) {
    ...
    public ResponseEntity<RespuestaAcceso> loginSubmit(
            @RequestBody PeticionAcceso peticionAcceso,
            HttpServletResponse response) {
        Usuario usuario = repositorioUsuario.findByCorreo(peticionAcceso.getCorreo());
        System.out.println("usuario" + usuario);
        if (usuario == null) {
            return new ResponseEntity<>(null, HttpStatus.NOT_FOUND);
        } else if (!usuario.getContraseña().equals(encryptPassword(peticionAcceso.getContraseña()))) {
